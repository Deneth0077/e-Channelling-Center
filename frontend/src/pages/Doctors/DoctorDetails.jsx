...
import stairIcon from '../../assets/images/Star.png'
          ...
          <div className='md:col-span-2'>
            <div className='flex items-center gap-5'>
              ...
              leading-4 lg:text-[16px] lg:leading-7 font-semibold rounded'>
                ...
                <h3 className='text-headingColor text-[22px] leading-9 mt-3 font-bold'> Heshan manohara</h3>
                <div className='flex items-center gap-[6px]'>
                  ...
                  <p className='text__para text-[14px] leading-6 md:text-[15px] lg:max-w-[390px] '>
                    ...
                    omnis officia similique quam quasi sunt quo maiores tempore, 
